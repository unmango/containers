      ...
      perSystem =
        { inputs', pkgs, ... }:
        {
          ...
          treefmt = {
            ...
            # Pinned base manifests and configs are generated by
            # scripts/update-manifest.sh: manifests verbatim as the registry
            # served them, configs normalised through `jq --sort-keys`.
